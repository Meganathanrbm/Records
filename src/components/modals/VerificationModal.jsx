        ...
        {isVerified ? (
          ...
          >
            <p style={{ textAlign: "center" }}>
              ...
              <span style={{ color: "#EB7C49", fontWeight: "500" }}>
                {userInput.verifierEmail}
              </span>
              <br />
              Your Education will be verified once the verifier accepted your
              request.{" "}
            </p>
          ...
          >
            <div className="form-row justify-content-center d-flex gap-4 ">
              ...
              >
                <label
                  ...
                  htmlFor="Enter your Verifier Email ID"
                >
                  Enter your Verifier Email ID
                </label>
                <input
            ...
            <p style={{ textAlign: "center" }}>
              The Verifier’s Email ID should be valid & It can be your
              <br /> Tutor, principal or any management{" "}
            </p>
